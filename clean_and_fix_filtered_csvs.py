import pandas as pd
import argparse
from dist_velocity_type_1_type_2_computation import optimized_function_maid_vectorized, remove_type_1, remove_type_2, remove_type_3, find_airports, convert_to_CRS
from combine_all_filtered_csvs import process_csv_files
from remove_unnecessary_records import remove_unnecessary_timestamps
import os
def main():
    ...
    # df_all.to_csv(args.output_csv+'\df_all_with_fixed_anolamies.csv', index=False)
    df_all = pd.read_csv(args.output_csv+'\df_all_with_fixed_anolamies.csv')
    print(df_all.shape)
